...
public class StrippingIndexBracketsLocalValidatorFactoryBean extends LocalValidatorFactoryBean {
    ...
    @Override
    protected MessageSourceResolvable getResolvableField(final @NonNull String objectName, final @NonNull String field) {
        ...
        return new DefaultMessageSourceResolvable(newCodesList.toArray(new String[0]), field);
    }
}
